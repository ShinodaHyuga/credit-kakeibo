      ...
      <main className="content">
        ...
        {activeTab === "rules" && (
          <RulesTab
            ...
            ruleFilterSourceType={rulesTab.ruleFilterSourceType}
            ruleFilterActive={rulesTab.ruleFilterActive}
            newSourceType={rulesTab.newSourceType}
            ...
            onChangeRuleFilterSourceType={rulesTab.onChangeRuleFilterSourceType}
            ...
            onChangeNewSourceType={rulesTab.onChangeNewSourceType}
